...
const listings = [
  {
    initials: "AT",
    bg: "bg-violet-200 text-violet-700",
    nom: "Awa Traoré",
    metier: "Coiffeuse à domicile · Cocody",
    note: "4.9",
  },
  {
    initials: "RG",
    ...
    nom: "Rose Goré",
    metier: "Esthéticienne · Deux-Plateaux",
    note: "4.9",
  },
];
      ...
      <div className="max-w-7xl mx-auto relative z-10 grid md:grid-cols-2 gap-16 items-center">
        <div>
          <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm mb-8">
            <span className="bg-babi-green text-white text-xs font-bold px-2.5 py-1 rounded-full">
              Nouveau
            </span>
          ...
          <p className="text-gray-600 mb-8 max-w-md leading-relaxed">
            Plombiers, coiffeuses, ménagères, traiteurs... Trouvez un pro
            vérifié, réservez en 2 clics et payez en toute sécurité. Partout à
            Abidjan.
          </p>

          <form
            onSubmit={handleSearch}
            className="bg-white rounded-full shadow-lg p-2 flex items-center gap-2 mb-8"
          >
            <div className="flex items-center gap-2 px-4 py-3 flex-1">
              <span className="text-lg opacity-60">
                ...
                >
                  <path
                    d="M10.6673 13.333V2.66634C10.6673 1.93045 10.0699 1.33301 9.33398 1.33301H6.66732C5.93143 1.33301 5.33398 1.93045 5.33398 2.66634V13.333"
                    stroke="#8A7A6E"
                    strokeWidth="1.33333"
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M2.66732 4H13.334C14.0699 4 14.6673 4.59745 14.6673 5.33333V12C14.6673 12.7359 14.0699 13.3333 13.334 13.3333H2.66732C1.93143 13.3333 1.33398 12.7359 1.33398 12V5.33333C1.33398 4.5975 1.93143 4 2.66732 4V4"
                    stroke="#8A7A6E"
                    strokeWidth="1.33333"
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <div className="flex items-center gap-2 px-4 py-3 flex-1">
              <span className="text-lg opacity-60">
                <svg
                  ...
                  fill="none"
                >
                  <g clipPath="url(#clip0_69_637)">
                    <path
                      d="M13.3327 6.66634C13.3327 9.99501 9.64002 13.4617 8.40002 14.5323C8.16271 14.7108 7.83599 14.7108 7.59868 14.5323C6.35868 13.4617 2.66602 9.99501 2.66602 6.66634C2.66602 3.72279 5.0558 1.33301 7.99935 1.33301C10.9429 1.33301 13.3327 3.72279 13.3327 6.66634"
                      stroke="#8A7A6E"
                      strokeWidth="1.33333"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M6 6.66699C6 7.77082 6.89617 8.66699 8 8.66699C9.10383 8.66699 10 7.77082 10 6.66699C10 5.56316 9.10383 4.66699 8 4.66699C6.89617 4.66699 6 5.56316 6 6.66699V6.66699"
                      stroke="#8A7A6E"
                      strokeWidth="1.33333"
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <input
                type="text"
                value={quartierQuery}
                onChange={(event) => setQuartierQuery(event.target.value)}
            ...
            <button
              type="submit"
              className="bg-babi-green text-white px-6 py-3 rounded-full font-semibold hover:-translate-y-0.5 hover:shadow-xl transition-all flex items-center gap-2 shrink-0"
            >
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex items-center gap-4">
            ...
            <p className="text-sm text-gray-600">
              <span className="font-bold text-babi-dark">
                2 400+ prestataires
              </span>{" "}
              vérifiés · note moyenne{" "}
              <span className="font-bold text-babi-dark">4,9/5</span>
            </p>
          </div>
        </div>
        ...
        <div className="relative">
          <span className="absolute -top-4 left-4 z-20 inline-flex items-center gap-1.5 bg-babi-dark text-white text-xs font-semibold px-3 py-2 rounded-full shadow-lg">
            ...
            >
              <path
                d="M8 1.33301L13.3333 3.33301V7.33301C13.3333 10.833 10.6667 13.333 8 14.6663C5.33333 13.333 2.66667 10.833 2.66667 7.33301V3.33301L8 1.33301Z"
                stroke="white"
                strokeWidth="1.33333"
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <div className="p-5">
              <div className="flex items-center gap-2 bg-gray-50 rounded-xl px-3 py-2.5 mb-3">
                ...
                <button
                  type="button"
                  onClick={() =>
                    navigate("/services?search=Coiffeuse&quartier=Cocody")
                  }
                  className="bg-babi-green text-white text-xs font-semibold px-3 py-1.5 rounded-lg"
                >
                  Rechercher
                </button>
              </div>
              ...
              <div className="flex items-center gap-2 mb-4">
                <span className="bg-babi-green text-white text-xs font-semibold px-3 py-1 rounded-full">
                  Disponible
                </span>
              ...
              <div className="flex flex-col gap-3">
                {listings.map((pro, index) => (
                  ...
                  >
                    <span
                      className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold shrink-0 ${pro.bg}`}
                    >
                      {pro.initials}
                    </span>
                    ...
                    <button
                      ...
                      className="bg-babi-green text-white text-xs font-semibold px-3 py-1.5 rounded-lg shrink-0"
                    >
                      Réserver
                    </button>
                  </div>
          ...
          <div className="absolute -bottom-6 -right-4 z-20 bg-white rounded-xl shadow-xl p-3 flex items-center gap-3 max-w-[220px]">
            ...
            <div>
              <p className="text-sm font-bold text-babi-dark leading-tight">
